...
Study length was strongly skewed for all parameters (Figure \ref{fig:fig2} B). Median study lengths were 3 (DIN), 2 (FIB), 2.5 (PO\textasciitilde4), 2.5 (TN), 2.5 (TP), and 2 (TSS) years.
...
The overall mean effect (estimated with the intercept only multilevel random effects model) showed significant mean reductions in FIB (ROM = 0.85, 95\% CI {[}0.36, 1.34{]}; BMP\textsubscript{eff} = 57.4\%, 95\% CI {[}30.4\%, 73.9\%{]}; Figure \ref{fig:fig4}) resulting from BMPs.
...
Overall effects showed that BMPs resulted in significant mean reductions in TN (ROM = 0.42, 95\% CI {[}0.21, 0.62{]}; BMP\textsubscript{eff} = 34.0\%, 95\% CI {[}18.7\%, 46.4\%{]}; Figure \ref{fig:fig4}) but not in DIN (ROM = 0.64, 95\% CI {[}-0.08, 1.35{]}; BMP\textsubscript{eff} = 47.1\%, 95\% CI {[}-8.1\%, 74.1\%{]}; Figure \ref{fig:fig4}).
...
Influent concentration (\(\beta\) = 0.27, 95\% CI {[}0.085, 0.44{]}) was significant for the PO\textsubscript{4} model (Figure \ref{fig:fig6}; Table S5).
...
\begin{figure}
\includegraphics[width=1\linewidth,]{frontiers_submission_files/figure-latex/fig1} \caption{Summary of (A) study scale, (B) dominant runoff source, and (C) BMPs identified in the systematic review.}\label{fig:fig1}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth,]{frontiers_submission_files/figure-latex/fig2} \caption{Number of studies identified in the systematic review summarized by (A) publication date and (B) study length.}\label{fig:fig2}
\end{figure}

\begin{figure}[p]
\includegraphics[width=1\linewidth,]{frontiers_submission_files/figure-latex/fig3} \caption{Distribution of studies identified in the systematic review by state and parameter.}\label{fig:fig3}
\end{figure}

\begin{figure}[p]
\includegraphics[width=1\linewidth,]{frontiers_submission_files/figure-latex/fig4} \caption{Estimated effect sizes and intervals from the intercept only multilevel random effects model. Individual points represent studies, with size scaled by sampling variance. The point estimate with uncertaintity bars indicate the estimated overall effect, 95\% confidence intervals, and 95\% prediction intervals. Here, \textit{k} indicates the number of overall effects with the number of unique studies in parenthesis.}\label{fig:fig4}
\end{figure}

\begin{figure}[p]
\includegraphics[width=1\linewidth,]{frontiers_submission_files/figure-latex/fig5} \caption{Predicted marignal effect of influent FIB and aridity index (conditioned on BMP subcategory). Solid lines are the predicted mean effect, dashed lines are the 95\% confidence intervals, and the dotted lines are the 95\% prediction intervals. Individual dots represent each effect size identified in the literature with the size scaled by sampling variance.}\label{fig:fig5}
\end{figure}

\begin{figure}[p]
\includegraphics[width=1\linewidth,]{frontiers_submission_files/figure-latex/fig6} \caption{Predicted marignal effect of influent pollutant concentration on TP (Panel A) and PO\textsubscript{4} (Panel B) reductions. Solid lines are the predicted mean effect, dashed lines are the 95\% confidence intervals, and the dotted lines are the 95\% prediction intervals. Individual dots represent each effect size identified in the literature with the size scaled by sampling variance.}\label{fig:fig6}
\end{figure}

\begin{figure}[p]
\includegraphics[width=0.5\linewidth,]{frontiers_submission_files/figure-latex/fig7} \caption{Comparison of the relative distributions (density) of aridity index values across the U.S. against aridity index values for studies in the systematic review.}\label{fig:fig7}
\end{figure}
